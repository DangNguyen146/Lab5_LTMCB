    ...
    public partial class ReceiveMail : Form
    {
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReadMail readMail = new ReadMail(name, pass, arrListStr[2].Trim().Substring(1, arrListStr[2].Trim().Length - 2), listView1.SelectedItems[0].SubItems[0].Text);
                readMail.Show();
            }
            catch
            {
        ...
        {
            SendMail sendMail = new SendMail(name, pass);
            sendMail.Show();
        }
